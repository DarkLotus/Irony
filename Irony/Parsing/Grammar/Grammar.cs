...
namespace Irony.Parsing
{
    ...
    public class Grammar
    {
        ...
        public Grammar(bool caseSensitive)
        {
            ...
            var stringComparer = StringComparer.OrdinalIgnoreCase; //.Create(System.Globalization.CultureInfo.InvariantCulture, ignoreCase);
        ...
        public KeyTerm ToTerm(string termValue)
        {
            return ToTerm(termValue, termValue);
        }
