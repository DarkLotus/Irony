        ...
        protected virtual object ConvertValue(ParsingContext context, string textValue)
        {
            switch (DataType)
            {
                ...
                case TypeCode.Double:
                    ...
                    return Convert.ChangeType(dValue, typeof(float), context.Culture);

                case TypeCode.Boolean:
                    return Convert.ToBoolean(textValue, context.Culture);
                case TypeCode.Byte:
                    return (IntRadix == 10) ? Convert.ToByte(textValue, context.Culture) : Convert.ToByte(textValue, IntRadix);
                case TypeCode.Char:
                    return Convert.ToChar(textValue, context.Culture);
                case TypeCode.Decimal:
                    return Convert.ToDecimal(textValue, context.Culture);
                case TypeCode.Int16:
                    return (IntRadix == 10) ? Convert.ToInt16(textValue, context.Culture) : Convert.ToInt16(textValue, IntRadix);
                case TypeCode.Int32:
                    return (IntRadix == 10) ? Convert.ToInt32(textValue, context.Culture) : Convert.ToInt32(textValue, IntRadix);
                case TypeCode.Int64:
                    return (IntRadix == 10) ? Convert.ToInt64(textValue, context.Culture) : Convert.ToInt64(textValue, IntRadix);
                case TypeCode.UInt16:
                    return (IntRadix == 10) ? Convert.ToUInt16(textValue, context.Culture) : Convert.ToUInt16(textValue, IntRadix);
                case TypeCode.UInt32:
                    return (IntRadix == 10) ? Convert.ToUInt32(textValue, context.Culture) : Convert.ToUInt32(textValue, IntRadix);
                case TypeCode.UInt64:
                    return (IntRadix == 10) ? Convert.ToUInt64(textValue, context.Culture) : Convert.ToUInt64(textValue, IntRadix);
